      ...
      case 'color-theory':
        return (
          <>
            ...
            <LatexText className="mb-4">
              {`$ $\begin{enumerate}
              \item Простота. Модель RGB довольно проста и наглядна в понимании и в своем представлении, данная цветовая модель из-за своей простоты используется в мониторах компьютера и цифровых дисплеях, т.к. для кодировки цвета достаточно трёх пикселей, отвечающих за разные цветовые каналы.
              \item Яркая и насыщенная цветовая гамма.
              \end{enumerate}$`}
            </LatexText>
