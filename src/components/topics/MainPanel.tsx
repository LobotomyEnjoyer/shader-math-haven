      ...
      case 'color-theory':
        return (
          <>
            ...
            <p className="mb-4">RGB - это цветовая модель, представляющая собой вектор с тремя координатами (R, G, B), где R - красный, G - зеленый, B&nbsp- синий. Обычно данная модель 8-битная, т.е. каждый цвет принимает значения в диапазоне [0, 255], т.е. 256 оттенков на каждый цвет. Разновидностью данной цветовой модели являются 16-битные модели и HDR (32-битные модели). Иногда RGB модель записывается в шестнадцатеричном формате (0xRRGGBB), принимающий значения в шестнадцатеричном диапазоне [0, F].</p>
          </>
        );
