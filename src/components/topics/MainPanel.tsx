      ...
      case 'color-theory':
        return (
          <>
            ...
            <h3 className="text-2xl font-bold mb-4">Преимущества модели RGB:</h3>


                <p>1) Простота. Модель RGB довольно проста и наглядна в понимании и в своем представлении, данная цветовая модель из-за своей простоты используется в мониторах компьютера и цифровых дисплеях, т.к. для кодировки цвета достаточно трёх пикселей, отвечающих за разные цветовые каналы.</p>
                <p>2) Яркая и насыщенная цветовая гамма.</p>

            
            <h3 className="text-2xl font-bold mb-4">Недостатки модели RGB:</h3>
